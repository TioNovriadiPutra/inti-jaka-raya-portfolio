  ...
  return (
    <AnimatedImageBackground
      ...
      style={[
        ...
        isMobile ? null : scaleAnimatedStyle,
      ]}
    ...
    >
      <LinearGradient
        ...
        style={[
          styles.backdrop,
          isMobile ? styles.backdropMobile : styles.backdropWeb,
        ]}
      >
        ...
        >
          UPS are able to offer unique solutions such as fluid flow equipment
          linings to corrosion protection for offshore platforms. Our unique
          solutions can be applied throughout all industrial sectors; Oil & Gas,
          Marine (ThistleBond), Power Generation, Paper & Pulp, Chemical &
          Corrosion, Water & Wastewater, Petrochemical & General Industry.
        </Text>
      </LinearGradient>
    </AnimatedImageBackground>
  );
